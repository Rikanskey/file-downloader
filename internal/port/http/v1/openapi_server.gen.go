...
type ServerInterface interface {
	...
	// (GET /files/{requestId})
	GetFiles(w http.ResponseWriter, r *http.Request, requestId string)
}
...
// (GET /files/{requestId})
func (_ Unimplemented) GetFiles(w http.ResponseWriter, r *http.Request, requestId string) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func (siw *ServerInterfaceWrapper) GetFiles(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetFiles(w, r, requestId)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/files", wrapper.CreateRequest)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/files/{requestId}", wrapper.GetFiles)
	})
